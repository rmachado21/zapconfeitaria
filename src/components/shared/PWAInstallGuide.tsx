...
const iosSteps = [
  {
    ...
    description: 'Acesse o site pelo navegador Safari. Depois, toque no ícone de compartilhar (quadrado com seta para cima) na barra inferior.',
  },
  {
    image: iosStep2,
...
export function PWAInstallGuide({ trigger }: PWAInstallGuideProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent 
        className="sm:max-w-lg max-h-[90dvh]"
