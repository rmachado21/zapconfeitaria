  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-medium whitespace-nowrap transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        terracotta: "border-transparent bg-primary/15 text-primary",
        chocolate: "border-transparent bg-accent/15 text-accent",
        cream: "border-transparent bg-cream text-chocolate",
      },
    },
    defaultVariants: {
      variant: "default",
