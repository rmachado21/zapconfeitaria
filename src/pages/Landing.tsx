    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b animate-fade-in">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {user ? (
              <Button onClick={() => navigate("/dashboard")}>Acessar App</Button>
            ) : (
              <>
                <Button variant="ghost" onClick={() => navigate("/auth")}>
                  Entrar
                </Button>
                <Button onClick={() => navigate("/auth?tab=signup")} className="rounded-full px-4 py-1 h-auto">
                  Criar Conta
                </Button>
              </>
            )}
      ...
      <section className="py-16 md:py-24 relative">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div
            className="absolute -bottom-40 -left-40 w-80 h-80 bg-terracotta-light/10 rounded-full blur-3xl animate-float"
            style={{
              animationDelay: "1.5s",
            }}
          />
        ...
        <div className="container mx-auto px-4 relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              >
                Chega de perder pedidos no WhatsApp e esquecer de cobrar o sinal. Gerencie pedidos, clientes, produtos e
              ...
              >
                <Button
                  ...
                  className="text-lg px-8 transition-transform hover:scale-105"
                >
                  Começar agora
            ...
            >
              <div className="relative">
                ...
                <div
                  className="absolute -bottom-4 -right-2 sm:-bottom-5 sm:-right-3 md:-bottom-6 md:-right-4 lg:-bottom-4 lg:-right-4 z-10 w-24 sm:w-32 md:w-44 lg:w-52 animate-float"
                  style={{
                    animationDelay: "0.6s",
                  }}
                >
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Confeiteiras que transformaram seus negócios</h2>
            <p className="text-muted-foreground text-lg">Veja o que dizem quem já usa o ZAP Confeitaria</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="border-0 shadow-sm transition-all duration-300 hover:shadow-lg">
                <CardHeader>
      ...
      <section id="pricing" className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Planos simples, sem surpresas</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {plans.map((plan, index) => (
              <Card
                key={plan.id}
                className={`relative flex flex-col transition-all duration-300 hover:shadow-xl hover:-translate-y-1 ${plan.badge ? "border-primary shadow-lg ring-2 ring-primary/20" : ""}`}
              >
                {plan.badge && (
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Pronta para organizar sua confeitaria?</h2>
