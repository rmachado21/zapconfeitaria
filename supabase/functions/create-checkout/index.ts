...
const PRICE_IDS = {
  monthly: "price_1SdsV1RoeoTQI3R30pZ29YYm",
  yearly: "price_1SdsYTRoeoTQI3R39FxH4vnS",
};
...
serve(async (req) => {
  ...
  try {
    ...
    logStep("Plan selected", { planType, priceId });
    ...
    const origin = req.headers.get("origin") || "https://izlokpafxhknkaheznxr.lovableproject.com";
